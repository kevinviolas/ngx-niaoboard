...
function DesktopFullScreenComponent_ng_container_3_div_2_ng_container_7_ng_container_3_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("@FadeSlideInOutKonversoTranslateOutTest", ctx_r13.animations.FadeSlideInOut(ctx_r13.animationTTX, -100))("innerHTML", i0.ɵɵpipeBind1(2, 2, ctx_r13.LastBotAnswer.text), i0.ɵɵsanitizeHtml);
} }
...
function DesktopFullScreenComponent_ng_container_3_div_2_ng_container_7_custom_checkbox_calendar_5_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵproperty("@FadeSlideInOutKonversoOpacityOut", ctx_r11.animations.FadeSlideInOut(ctx_r11.animationTTX, ctx_r11.animationSlideValue))("state", ctx_r11.afterProcess)("calendarTemplate", ctx_r11.calendarTemplate)("columnOverride", ctx_r11.calendarKeyOverride);
} }
