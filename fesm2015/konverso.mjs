...
function CustomCheckboxCalendarComponent_ng_container_5_Template(rf, ctx) {
    ...
    if (rf & 2) {
        ...
        i0.ɵɵadvance(1);
        i0.ɵɵstyleMap(i0.ɵɵpureFunction1(4, _c0$1, "calc(100% / " + ctx_r1.column.length + ")"));
        i0.ɵɵadvance(1);
