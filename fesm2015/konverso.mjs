...
function DesktopFullScreenComponent_ng_container_3_div_2_div_10_ng_container_4_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelementContainerStart(0);
        i0.ɵɵtext(1);
        i0.ɵɵelementContainerEnd();
...
function DesktopFullScreenComponent_ng_container_3_div_2_div_10_button_6_Template(rf, ctx) {
    if (rf & 1) {
